...
\begin{table}[!t]
\centering
\caption{Direct-regression and wrapped external backbone baselines under the release-separated protocol. Values are mean $\pm$ sample standard deviation over seeds 2025--2029. Lower nRMSE is better.}
\label{tab:r11_regression_baselines}
\scriptsize
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.15}
\begin{tabularx}{\linewidth}{@{} >{\RaggedRight\arraybackslash}p{0.22\linewidth} Y c c @{}}
\toprule
\textbf{Model} & \textbf{Role} & \textbf{Valid nRMSE} $\downarrow$ & \textbf{R11 nRMSE} $\downarrow$ \\
\midrule
MSP-CNN & compact scalar regression baseline & 0.900595 $\pm$ 0.005096 & 0.899795 $\pm$ 0.008045 \\
ETR-CNN & temporal-readout direct regression & 0.900822 $\pm$ 0.006043 & 0.897679 $\pm$ 0.006773 \\
ETR-CNN large & capacity ablation & 0.897233 $\pm$ 0.004022 & 0.892783 $\pm$ 0.004161 \\
TIDNet wrapped & strongest external supervised baseline in this comparison & 0.923506 $\pm$ 0.002357 & 0.919204 $\pm$ 0.002739 \\
EEGConformer wrapped & modern supervised transformer-style baseline & 0.918845 $\pm$ 0.002634 & 0.928656 $\pm$ 0.005658 \\
EEGNet wrapped & canonical compact EEG baseline & 0.935037 $\pm$ 0.005384 & 0.933504 $\pm$ 0.002832 \\
LaBraM wrapped & foundation-style architecture from scratch & 0.930388 $\pm$ 0.006065 & 0.932722 $\pm$ 0.008568 \\
Deep4Net wrapped & classical convolutional baseline & 0.926883 $\pm$ 0.004521 & 0.925972 $\pm$ 0.004354 \\
ShallowFBCSPNet wrapped & classical filter-bank spatial convolution baseline & 0.932353 $\pm$ 0.001632 & 0.934285 $\pm$ 0.002423 \\
ATCNet wrapped & supervised conv/attention/TCN baseline & 0.968640 $\pm$ 0.018283 & 0.966578 $\pm$ 0.015093 \\
\bottomrule
\end{tabularx}
\end{table}
