...
\begin{table}[!t]
\centering
\caption{Event-time objective variants with a fixed ETS-U-Net backbone. Values are mean $\pm$ sample standard deviation over seeds 2025--2029.}
...
\toprule
\textbf{Model} & \textbf{Role} & \textbf{Valid nRMSE} $\downarrow$ & \textbf{R11 nRMSE} $\downarrow$ & \textbf{R11 \(\tau\)-nRMSE} $\downarrow$ \\
\midrule
\multicolumn{5}{@{}l}{\textit{Soft-target objective}} \\
\addlinespace[0.15em]
CE & soft event-time target & \mbox{0.8763 $\pm$ 0.0044} & \mbox{0.8774 $\pm$ 0.0044} & \mbox{0.8753 $\pm$ 0.0039} \\
\midrule
\multicolumn{5}{@{}l}{\textit{Likelihood-based objectives}} \\
\addlinespace[0.15em]
EventNLL & Gaussian observation kernel & \mbox{0.8769 $\pm$ 0.0030} & \mbox{0.8805 $\pm$ 0.0021} & \mbox{0.8772 $\pm$ 0.0018} \\
Mixture EventNLL & two-scale observation kernel & \mbox{0.8744 $\pm$ 0.0018} & \mbox{0.8785 $\pm$ 0.0047} & \mbox{0.8745 $\pm$ 0.0053} \\
Hazard EventNLL & hazard posterior parameterization & \mbox{0.8755 $\pm$ 0.0027} & \mbox{0.8776 $\pm$ 0.0031} & \mbox{0.8778 $\pm$ 0.0041} \\
\midrule
\multicolumn{5}{@{}l}{\textit{Readout and distance controls}} \\
\addlinespace[0.15em]
Time-only & scalar soft-argmax control & \mbox{0.8944 $\pm$ 0.0048} & \mbox{0.8943 $\pm$ 0.0025} & \mbox{0.8917 $\pm$ 0.0046} \\
Wasserstein & CDF-distance control & \mbox{0.8997 $\pm$ 0.0035} & \mbox{0.8995 $\pm$ 0.0078} & \mbox{0.8896 $\pm$ 0.0033} \\
\bottomrule
\end{tabularx}
\end{table}
