...
\begin{enumerate}
    \item We recast behavioral RT labels as weak event-time supervision signals and formulate EEG RT decoding as event-time posterior modeling rather than direct scalar regression.
    ...
    \item We use posterior geometry, shifted-crop inference, and shift-jitter training to separate scalar accuracy from temporal evidence, uncertainty, shortcut behavior, and partial response-timing localization.
\end{enumerate}
...
\toprule
\textbf{Objective} & \textbf{nRMSE} & \textbf{Fixed NLL} & \textbf{Width80 ms} & \textbf{Mass $\pm$150 ms} & \textbf{Coverage80} & \textbf{Coverage MAE} \\
\midrule
...
Mixture EventNLL & 0.874 $\pm$ 0.005 & -0.08 $\pm$ 0.01 & 528 $\pm$ 22 & 0.471 $\pm$ 0.008 & 0.573 $\pm$ 0.020 & 0.207 $\pm$ 0.017 \\
Hazard EventNLL & 0.878 $\pm$ 0.004 & -0.06 $\pm$ 0.01 & 445 $\pm$ 14 & 0.502 $\pm$ 0.005 & 0.468 $\pm$ 0.007 & 0.302 $\pm$ 0.006 \\
Soft-argmax RT loss & 0.892 $\pm$ 0.005 & 0.11 $\pm$ 0.03 & 844 $\pm$ 96 & 0.357 $\pm$ 0.015 & 0.843 $\pm$ 0.029 & 0.040 $\pm$ 0.024 \\
Wasserstein & 0.890 $\pm$ 0.003 & 0.20 $\pm$ 0.04 & 632 $\pm$ 101 & 0.334 $\pm$ 0.028 & 0.774 $\pm$ 0.061 & 0.059 $\pm$ 0.021 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
Temperature grid & Objective-specific grid & \(0.4\)--\(1.8\) with step 0.05 for CE/EventNLL/time-only objectives; \(0.2\)--\(3.5\) with step 0.05 for Wasserstein. \\
\midrule
