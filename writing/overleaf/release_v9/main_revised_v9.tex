...
\begin{enumerate}
    ...
    \item We use posterior geometry, shifted-crop inference, and shift-jitter training to separate scalar accuracy from temporal evidence, uncertainty, shortcut behavior, and partial event localization.
\end{enumerate}
