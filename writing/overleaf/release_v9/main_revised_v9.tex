...
\section{Additional Readout and Shifted-Crop Details}

This appendix records the two protocol details that are secondary to the main narrative but important for reproducing the posterior diagnostics. First, the posterior readout temperature is selected only on the R9--R10 development split and then applied unchanged to the holdout split. Second, the shifted-crop table in the main text reports seed means for readability; the full seed-variability summary is given here.
