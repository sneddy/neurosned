...
| `corr_mean_abs`   | Mean **absolute** value of all entries of $corr(X_t, X_{t+\text{lag}})$.                                 | Reflects global **synchronization strength** across channels.                                  | 10 (0.10 s), 25 (0.25 s), 50 (0.50 s)                           |
| `corr_off_mean`   | Mean of **off-diagonal** entries of $corr(X_t, X_{t+\text{lag}})$.                                       | Measures **inter-channel coupling/integration** independent of self-effects.                   | 5 (0.05 s), 50 (0.50 s)                                         |
