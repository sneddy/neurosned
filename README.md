...
![Workflow diagram](assets/Figure_main_1.png)
...
- **Target smoothing schedule.** It’s good practice to **decrease `sigma (σ)`** (for the soft target) over time; start larger, then anneal.
...
| ------ | --------------: | -----------------: | ---------------: | ----------: |
| [unet_deeper_widen4_v1 ⬇️](https://drive.google.com/uc?export=download&id=1a3c0uE_7-qWPUc3dJsSSZPe0xCiE3y0R) | 0.902532 | 0.902324 | 1.076 | 20.8 MB |
| [unet_deeper_v4 ⬇️](https://drive.google.com/uc?export=download&id=1AYZbVjeGIcAnm-hnIUWUYZe9I1wNWI0M) | 0.898899 | 0.898757 | 1.076 | 12.5 MB |
| [unet_v4 ⬇️](https://drive.google.com/uc?export=download&id=16S-lhiIZuST0mdsHFjqgg6vzOlqjvxnD) | 0.903785 | 0.903785 | 1.000 | 9.2 MB |
| [attention_unet_v2 ⬇️](https://drive.google.com/uc?export=download&id=1n2QZTwpzYXb6WENQNvDuDuw8ncz-npmg) | 0.901512 | 0.901511 | 1.028 | 130 MB |
| [inception_v0 ⬇️](https://drive.google.com/uc?export=download&id=1yN3Flqmmf6h4kZcdmmlnx-GfyhKZXOw3) | 0.917441 | 0.916910 | 1.124 | 0.66 MB |
| [factorization_unet_v1_finetune ⬇️](https://drive.google.com/uc?export=download&id=1rsPZE6ArV3ntqLpd5Ip1pIiRBuVkQ27t) | 0.910517 | 0.909281 | 1.221 | 41 MB |
...
| ----------------- | ------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `corr_diag_mean`  | Mean of the **diagonal** of the lagged correlation matrix $\mathrm{corr}(X_t, X_{t+\text{lag}})$ across channels. | Captures **within-channel stability/persistence**; altered short–mid stability is informative. | 5 (0.05 s), 10 (0.10 s), 25 (0.25 s)                            |
| `corr_mean_abs`   | Mean **absolute** value of all entries of $\mathrm{corr}(X_t, X_{t+\text{lag}})$.                                 | Reflects global **synchronization strength** across channels.                                  | 10 (0.10 s), 25 (0.25 s), 50 (0.50 s)                           |
| `corr_off_mean`   | Mean of **off-diagonal** entries of $\mathrm{corr}(X_t, X_{t+\text{lag}})$.                                       | Measures **inter-channel coupling/integration** independent of self-effects.                   | 5 (0.05 s), 50 (0.50 s)                                         |
...
| `A_diag_mean`     | Mean of the **diagonal** of ridge transition matrix $A$ from $X_{t+\text{lag}} ≈ A X_t$.                 | Indicates **self-prediction/persistence** in linear dynamics over the lag.                     | 50 (0.50 s), 100 (1.00 s)                                       |
