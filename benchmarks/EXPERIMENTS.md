...
| unet_deeper_sigma012 | 2026-06-29 15:48 UTC | `configs/00_protocol_calibration/`<br>`unet_deeper_sigma012.yaml` | `experiments/00_protocol_calibration/`<br>`unet_deeper_sigma012__20260629_154841` | Same as default, only soft-label sigma reduced from 0.15 to 0.12. |
...
| unet_deeper_sigma012 | 15 | 0.931072 | Slightly worse than sigma=0.15 baseline; sharper labels do not look useful for the simple protocol. |
